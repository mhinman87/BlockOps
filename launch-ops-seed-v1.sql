...
with milestone_lookup as (
  ...
  select * from (values
    ('M1-03', 'Map the two lead pipelines', 'Document the AI chat lead path and Adrian''s network lead path from first touch to intake.', 'Adrian', 'this_week', 'critical', 'Lead Capture', 'm1-mock-run-build-ready', false, false, false, 30),
    ...
    ('M1-09', 'Define the follow-up workflow and schedule', 'Drafted in Obsidian Outreach Sequence page: first touch within 1 business day, second touch Day 2–3, third touch Day 5–7, close-loop/nurture/recycle Day 10–14. Needs Adrian validation.', 'Adrian', 'review', 'critical', 'Outreach Sequence', 'm1-mock-run-build-ready', false, false, true, 90),
    ...
    ('M1-OS-06', 'Define follow-up Day 2–3 touch', 'Drafted in Obsidian Outreach Sequence page: if no response after 2–3 business days, send follow-up email/text and optionally call if phone exists and warmth/value justifies it. Needs Adrian validation.', 'Adrian', 'review', 'high', 'Outreach Sequence', 'm1-mock-run-build-ready', false, false, true, 94),
    ('M1-OS-07', 'Define follow-up Day 5–7 touch', 'Drafted in Obsidian Outreach Sequence page: if still no response, send final value-focused nudge and optionally call high-value/warm leads. Needs Adrian validation.', 'Adrian', 'review', 'high', 'Outreach Sequence', 'm1-mock-run-build-ready', false, false, true, 95),
    ('M1-OS-08', 'Define Day 10–14 close-loop / nurture rule', 'Drafted in Obsidian Outreach Sequence page: after no response to final nudge, move to No Response/Stalled, Nurture/Recycle Later, Future Market/Geography Hold, or Closed/No Response. Needs Samir/Adrian validation.', 'Adrian', 'review', 'high', 'Outreach Sequence', 'm1-mock-run-build-ready', false, false, true, 96),
    ('M1-OS-09', 'Define call attempt rule', 'Drafted in Obsidian Outreach Sequence page: calls depend on source, warmth, phone availability, and lead value; website/AI-chat is email-first unless high-intent, network/referral can justify call/text. Needs Adrian validation.', 'Adrian', 'review', 'high', 'Outreach Sequence', 'm1-mock-run-build-ready', false, false, true, 97),
    ...
    ('M1-WIKI-01', 'Import drafted Wiki pages into admin Block Ops Wiki', 'Completed 2026-07-03: actual admin Wiki surface uses Supabase wiki_sections and wiki_pages, not the legacy Knowledge Library route. Imported 35 Obsidian-drafted pages; verified 40 total live admin Wiki pages. Content remains internal review material only, not client-facing final content.', 'Bloq', 'done', 'critical', 'Platform & Internal/Client System', 'm1-mock-run-build-ready', true, true, true, 168),
    ('M1-WIKI-02', 'QA imported admin Wiki pages and set promotion labels', 'Next step after live import: review imported pages starting with Company Identity, mark current internal vs needs review/hold/archive, preserve 12 admin/backend sections for now, and map reviewed content to the official six-pillar spine later.', 'Samir', 'ready', 'critical', 'Platform & Internal/Client System', 'm1-mock-run-build-ready', true, true, true, 169),
    ...
    ('M1-WIKI-04', 'QA Company Identity Wiki pages', 'Review Mission, Vision, Positioning and Core Story, Pillar Model / Gold Standard Tree, and Implementation Bundles. Mark each page current internal, needs review, hold, or archive/reference.', 'Samir', 'this_week', 'critical', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', false, false, true, 177),
    ('M1-WIKI-05', 'QA Sales and Client Pipeline Wiki pages', 'Review lead capture, outreach sequence, CRM pipeline stages, communication log, qualification/discovery, proposal workflow, and sales materials/scripts. Validate Adrian-facing sales language and remove unsupported claims.', 'Adrian', 'ready', 'critical', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', true, true, true, 178),
    ('M1-WIKI-06', 'QA Operating Model Wiki pages', 'Review operating system, roles and ownership, Mission Control rules, weekly ops review, decision capture, and status rules so internal execution language matches how the team works.', 'Samir', 'ready', 'high', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', false, false, true, 179),
    ('M1-WIKI-07', 'QA Digital Platform Wiki pages', 'Review digital platform overview, client portal, dashboard, Mission Control, Block Ops Wiki / Compendium, Supabase data model, and design handoff process with Max for technical accuracy.', 'Max', 'ready', 'critical', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', false, false, true, 180),
    ('M1-WIKI-08', 'QA Delivery and Clinical Knowledge Wiki pages', 'Review client onboarding, implementation bundle delivery, training day readiness, go-live verification, and clinical/block program knowledge index. Keep clinical and deliverable content fact-review gated.', 'Samir', 'ready', 'critical', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', true, false, true, 181),
    ('M1-WIKI-09', 'QA Legal Risk Archive and Growth Wiki pages', 'Review legal review index, compliance and risk controls, acquisition/growth strategy, backup and continuity, and decision log/archive rules. Keep legal/compliance items review-gated.', 'Samir', 'ready', 'critical', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', true, true, true, 182),
    ('M1-WIKI-10', 'Define Wiki promotion and review labels', 'Lock the operating labels for imported Wiki pages: current internal, needs Samir review, needs Adrian review, needs Max review, legal/clinical hold, archive/reference, and client-facing candidate.', 'Samir', 'ready', 'high', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', true, true, true, 183),
