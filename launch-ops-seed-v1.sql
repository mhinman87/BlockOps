...
with milestone_lookup as (
  ...
  select * from (values
    ...
    ('M1-WIKI-05', 'QA Sales and Client Pipeline Wiki pages', 'Review lead capture, outreach sequence, CRM pipeline stages, communication log, qualification/discovery, proposal workflow, and sales materials/scripts. Validate Adrian-facing sales language and remove unsupported claims.', 'Adrian', 'this_week', 'critical', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', true, true, true, 178),
