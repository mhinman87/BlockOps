...
with milestone_lookup as (
  ...
  select * from (values
    ...
    ('M1-WIKI-07', 'QA Digital Platform Wiki pages', 'Review digital platform overview, client portal, dashboard, Mission Control, Block Ops Wiki / Compendium, Supabase data model, and design handoff process with Max for technical accuracy.', 'Max', 'this_week', 'critical', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', false, false, true, 180),
