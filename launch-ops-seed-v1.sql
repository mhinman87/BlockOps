...
with milestone_lookup as (
  ...
  select * from (values
    ...
    ('M1-CL-04', 'Test communication log with both mock-client paths', 'Executed 2026-07-18 with website and Adrian/network live mock leads. Nine lead_notes preserve history, but fields are prose-only and protected admin UI visibility still needs Max implementation and Bloq retest.', 'Bloq', 'review', 'high', 'Client Communication Log', 'm1-mock-run-build-ready', false, false, true, 113),
    ('M1-QD-01', 'Define Initial Fit Conversation question bank', 'Samir-approved business model: every 15–20 minute Initial Fit Conversation covers five core areas with conditional prompts used only when relevant; Unknowns remain explicit and Adrian must validate sales language.', 'Adrian', 'review', 'high', 'Qualification and Discovery', 'm1-mock-run-build-ready', false, false, true, 120),
    ('M1-QD-02', 'Define qualification scoring and disqualifiers', 'Approved hybrid model: confirmed hard stops first; eight factors rated 0–2 with Unknown separate; score guides but does not replace Advance, Advance with Conditions, Need More Information, Nurture, or Pass.', 'Samir', 'done', 'high', 'Qualification and Discovery', 'm1-mock-run-build-ready', false, false, true, 121),
    ('M1-QD-03', 'Define prospect brief requirements', 'Samir approved one staged living Prospect Brief: Stage 1 opportunity snapshot after Initial Fit; Stage 2 assessment-ready expansion only when advancing. Adrian validates sales practicality and Max verifies no-duplicate-entry CRM support.', 'Adrian', 'review', 'high', 'Qualification and Discovery', 'm1-mock-run-build-ready', false, false, true, 122),
    ('M1-QD-04', 'Define Client Assessment Meeting question banks', 'Approved: Client Assessment Meeting is required before Proposal Preparation; all five assessment areas must be answered or explicitly unresolved, and material unknowns block proposal creation.', 'Samir', 'done', 'high', 'Qualification and Discovery', 'm1-mock-run-build-ready', false, false, true, 123),
    ('M1-QD-05', 'Test fit and assessment journey with mock-client paths', 'Executed 2026-07-18 against two live Supabase mock leads. Operating flow passed; source/status taxonomy, structured communication/qualification/brief fields, and protected admin UI verification remain Max-owned blockers.', 'Bloq', 'review', 'high', 'Qualification and Discovery', 'm1-mock-run-build-ready', false, false, true, 124),
    ...
    ('M1-OM-07', 'Review Batch 3 operating model pages', 'Completed 2026-07-18: Samir approved Batch 3 operating-model pages and the display rule that formal M1–M5 milestone names appear consistently across the internal Wiki, Mission Control, Dashboard, Obsidian, and source records, paired with short plain-language explanations when useful. Remaining technical implementation checks stay with Max-owned tasks.', 'Samir', 'done', 'high', 'Operating Model', 'm1-mock-run-build-ready', false, false, true, 156),
    ('M1-DP-01', 'Define digital platform surface map', 'Completed 2026-07-18: Samir''s approved platform boundaries were reconciled into one surface map. Client Portal is approved-final client-facing; Dashboard is the internal summary; Mission Control is execution; the Wiki is the governed reading layer; Obsidian is authoring/agent mirror/continuity; Supabase is canonical live state; GitHub is code/version history; and Vercel is deployment. Internal Dashboard/prototype remains separate from the client-facing app. Max-owned technical verification remains separate.', 'Samir', 'done', 'high', 'Platform & Internal/Client System', 'm1-mock-run-build-ready', false, false, true, 160),
    ...
    ('M1-DP-03', 'Define internal Dashboard rules', 'Samir approved the business rules: Dashboard is the calm internal summary home with current milestone, overall progress, and individual task progress; it shortcuts into Mission Control without becoming a task dump. Bloq appears as Bloq (AI) only when it owns active Mission Control tasks, remains internal-only, and never appears in the client portal. Max still owns implementation verification.', 'Max', 'review', 'high', 'Platform & Internal/Client System', 'm1-mock-run-build-ready', false, false, true, 162),
    ...
    ('M1-DP-05', 'Define internal Wiki / Compendium behavior', 'Completed 2026-07-18: Samir''s approved Wiki/Compendium behavior is locked. Supabase is canonical live state; the internal Wiki is the governed reading/search layer; Obsidian is the authoring, agent-mirror, source-context, and continuity layer; Mission Control links execution to Wiki context; and the client portal remains separate and approved-final only. Max-owned search, navigation, permissions, and UI verification remain separate.', 'Samir', 'done', 'high', 'Platform & Internal/Client System', 'm1-mock-run-build-ready', false, false, true, 164),
    ...
    ('M1-DP-08', 'Review Batch 4 digital platform pages', 'Completed 2026-07-18: Samir reviewed Batch 4 business behavior and approved the last open display rule: show Bloq as Bloq (AI) on the internal Dashboard only when it owns active Mission Control tasks; never expose Bloq ownership in the client portal. Max-owned schema, RLS, deployment, search, navigation, layout, and UI checks remain separate technical tasks.', 'Samir', 'done', 'high', 'Platform & Internal/Client System', 'm1-mock-run-build-ready', false, false, true, 167),
    ...
    ('M1-WIKI-11', 'Map reviewed Wiki pages to the six-pillar spine', 'Completed 2026-07-09: audited 41 existing live Wiki pages, preserved five legitimate live-only pages, created the governed six-pillar page map as the 42nd live page, and assigned every page exactly one primary official pillar with optional secondary pillars. Added fail-closed canonical metadata for 37 repository Wiki items while retaining the current 12-section backend/admin structure. No visible category rename, review completion, content promotion, or client-facing publication occurred; durable live pillar fields/navigation remain Max implementation work.', 'Bloq', 'done', 'high', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', false, false, true, 184),
    ('M1-WIKI-12', 'Link M1 Mission Control tasks to primary Wiki pages', 'Completed 2026-07-09: created a controlled one-primary-page context map for all 112 canonical M1 tasks and every expanded live M1 task. Added fail-closed governed-target tests, live primary_wiki_page_id synchronization, source schema/index/foreign-key setup, and visible Wiki context titles in Mission Control task details. Existing expanded task rows were preserved; no Wiki page was promoted or exposed to clients.', 'Bloq', 'done', 'high', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', false, false, true, 185),
    ('M1-WIKI-13', 'Identify client-facing Wiki candidates without publishing them', 'Completed 2026-07-09: audited all 42 governed live Wiki pages and created the internal Block Ops Wiki Client-Facing Candidate Register as the 43rd governed page. Classified 0 whole-page candidates, 17 excerpt/derivative candidates, 3 deferred pages, and 22 permanent-internal pages with exact audience, scope, required review gates, and exclusions. No source page was promoted, published, or made client-visible; every possible future candidate still requires an exact-version artifact, applicable qualified reviews, business release, and client-path verification.', 'Samir', 'done', 'high', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', true, true, true, 186),
    ('M1-WIKI-14', 'Run Wiki buildout acceptance check', 'Completed 2026-07-09: accepted the first governed Wiki buildout after verifying 43 live governed pages, internal title/description/tag/body search coverage, conservative review labels, 43 of 43 pillar assignments, correct primary Wiki context for all 328 live M1 tasks, synchronized Obsidian operating records, and zero draft Wiki items returned to client library results. Added fail-closed acceptance regression tests. This closes the buildout pass without promoting any page or claiming that future final-review, schema/UI enforcement, or client-leak workflows are complete.', 'Bloq', 'done', 'critical', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', true, true, true, 187),
    ...
    ('M1-WIKI-LINK-01', 'Create Block Ops Wiki cross-linking map', 'Completed 2026-07-09: defined a controlled 43-page cross-link graph with 214 governed links, explicit concept clusters, six topic indexes, primary-pillar fallbacks, and visibility-safe traversal rules.', 'Bloq', 'done', 'high', 'Wiki Cross-Linking', 'm1-mock-run-build-ready', false, false, true, 193),
    ('M1-WIKI-LINK-02', 'Add related-page blocks to core Wiki pages', 'Completed 2026-07-09: added deterministic Related Pages blocks and related-page metadata to every repository Wiki page while preserving internal-only status and filtering every static target to an available governed page.', 'Bloq', 'done', 'high', 'Wiki Cross-Linking', 'm1-mock-run-build-ready', false, false, true, 194),
    ('M1-WIKI-LINK-03', 'Add inline Wiki links where they improve navigation', 'Completed 2026-07-09: converted natural Obsidian Wiki links into clickable internal navigation in the Dashboard Wiki viewer, with fail-closed client traversal that requires both exact pages to be client-visible finals.', 'Bloq', 'done', 'medium', 'Wiki Cross-Linking', 'm1-mock-run-build-ready', false, false, true, 195),
    ('M1-WIKI-LINK-04', 'Create Wiki hub and index pages', 'Completed 2026-07-09: established Sales / Outreach, Mission Control, Client Portal, Wiki Governance, Implementation Bundle, and M1 indexes using governed anchor pages rather than duplicate content.', 'Bloq', 'done', 'medium', 'Wiki Cross-Linking', 'm1-mock-run-build-ready', false, false, true, 196),
    ('M1-WIKI-LINK-05', 'Run Wiki link QA and client-leak check', 'Completed 2026-07-09: automated link QA passed across 43 governed pages and 214 links with zero broken targets, orphan pages, pages without outbound links, or client-leak paths. Regression tests cover link parsing, related blocks, hubs, and fail-closed visibility.', 'Max', 'done', 'high', 'Wiki Cross-Linking', 'm1-mock-run-build-ready', false, false, true, 197),
    ...
    ('M1-35', 'Define pause vs close rule', 'Completed 2026-07-18: keep a lead active only while its outreach cadence remains open or a response has produced a dated next action. At the no-response threshold, pause it as No Response / Stalled and assign a human review date; never close automatically. Use Nurture / Recycle Later only with a specific temporary reason and re-entry trigger. Use Closed / No Response only after human review finds no near-term action and no justified nurture path; use Closed / Not Interested for an explicit do-not-contact request or firm permanent rejection; and use Not Fit only for a documented mismatch. Preserve the complete record and history in every path.', 'Samir', 'done', 'medium', 'No-Response / Stalled Lead', 'm1-mock-run-build-ready', false, false, true, 350),
