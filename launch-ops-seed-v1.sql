...
with milestone_lookup as (
  ...
  select * from (values
    ...
    ('M1-WIKI-08', 'QA Delivery and Clinical Knowledge Wiki pages', 'Review client onboarding, implementation bundle delivery, training day readiness, go-live verification, and clinical/block program knowledge index. Keep clinical and deliverable content fact-review gated.', 'Samir', 'this_week', 'critical', 'Block Ops Wiki Buildout', 'm1-mock-run-build-ready', true, false, true, 181),
