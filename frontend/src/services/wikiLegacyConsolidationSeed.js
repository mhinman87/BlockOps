...
- archive source pages only after useful material is mapped and verified.`),
  ...
  'Block Ops Wiki Go-Live Readiness Matrix': block('2026-07-10 consolidation extension', `At the conclusion of the 2026-07-10 consolidation pass, the governed live baseline was **48 pages** after adding five internal-draft consolidation pages. All 48 had one valid primary pillar, governed cross-links, and internal-only treatment. The original M1-WIKI-13 42-page candidate audit remains a historical baseline; the five added pages are permanent-internal sources and were not promoted or made client-visible. Live governance tooling controls the current inventory count.`),
  'Block Ops Wiki Six-Pillar Page Map': block('2026-07-10 map extension', `At the conclusion of the 2026-07-10 consolidation pass, the governed live baseline was **48 pages**. The original 43-page map remains historical context; these five pages were added with fail-closed pillar metadata:
...
No backend section was renamed and no page was promoted to client-visible.`),
  'Wiki Cross-Linking Map': block('2026-07-10 graph extension', `At the conclusion of the 2026-07-10 consolidation pass, the governed graph covered **48 pages** and **246 related-page links** across six indexes. That verification found no broken links, orphan pages, pages without outbound links, client-leak paths, or status changes. Live governance tooling controls current graph counts.`),
  'Block Ops Wiki Client-Facing Candidate Register': block('2026-07-10 candidate-register extension', `Five internal-draft pages were added during the legacy consolidation: [[Recurring Client Support]], [[Renewal and Expansion]], [[Client Health and Retention]], [[Client Offboarding and Access Closure]], and [[Launch History — M1 through M5]]. All five are classified **permanent-internal** for this pass. They were not nominated, promoted, or exposed to clients. The original 42-page M1-WIKI-13 table and the resulting 48-page inventory remain historical audit baselines; live governance tooling controls the current inventory.`),
});
