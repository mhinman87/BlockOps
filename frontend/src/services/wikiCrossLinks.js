...
const EXPLICIT_LINKS = Object.freeze({
  ...
  'Proposal Workflow': ['Qualification and Discovery', 'Sales Materials and Scripts', 'Implementation Bundles'],
  ...
  'Decision Capture': ['Mission Control', 'Decision Log / Historical Archive', 'Weekly Ops Review'],
