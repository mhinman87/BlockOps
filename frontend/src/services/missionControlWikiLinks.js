...
export const M1_WORKSTREAM_PRIMARY_WIKI_PAGE = Object.freeze({
  ...
  'Initial Fit Conversation': 'Qualification and Discovery',
  'Opportunity Review': 'Qualification and Discovery',
  'Client Assessment Meeting': 'Qualification and Discovery',
  'Proposal Preparation': 'Proposal Workflow',
  'Proposal Review Meeting': 'Proposal Workflow',
  'Client Decision': 'Proposal Workflow',
  'Contract & Signature': 'Proposal Workflow',
  'Client Kickoff': 'Client Onboarding',
...
export const M1_TASK_PRIMARY_WIKI_PAGE_OVERRIDES = Object.freeze({
  ...
  'M2-OPS-01': 'Site Readiness Assessment',
  'M2-OPS-02': 'Foundational Client Readiness and Completion Matrix',
  'M2-OPS-03': 'Supabase Data Model',
  'M2-OPS-04': 'Foundational Client Readiness and Completion Matrix',
  'M2-16': 'Foundational Client Readiness and Completion Matrix',
  'M3-EXEC-01': 'Foundational Client Readiness and Completion Matrix',
  'M4-01': 'Foundational Client Readiness and Completion Matrix',
  'M4-02': 'Site Readiness Assessment',
  'M4-03': 'Go-Live Verification',
  'M4-04': 'Foundational Client Readiness and Completion Matrix',
  'M4-05': 'Foundational Client Readiness and Completion Matrix',
  'M5-01': 'Client Onboarding',
  'M5-02': 'Site Readiness Assessment',
  'M5-03': 'Client Onboarding',
  'M5-04': 'Recurring Client Support',
