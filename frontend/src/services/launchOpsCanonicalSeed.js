...
export const CANONICAL_LAUNCH_TASKS = [
  ...
  {
    "taskKey": "M1-WIKI-02",
    "title": "QA imported admin Wiki pages and set promotion labels",
    "description": "Next step after live import: review imported pages starting with Company Identity, mark current internal vs needs review/hold/archive, preserve 12 admin/backend sections for now, and map reviewed content to the official six-pillar spine later.",
    "primaryOwner": "Samir",
    "status": "ready",
    "priority": "critical",
    "workstream": "Platform & Internal/Client System",
  ...
  },
  {
    ...
    "description": "Review operating system, roles and ownership, Mission Control rules, weekly ops review, decision capture, and status rules so internal execution language matches how the team works.",
    "primaryOwner": "Samir",
    "status": "this_week",
    "priority": "high",
    "workstream": "Block Ops Wiki Buildout",
  ...
  },
  {
    ...
    "description": "Review digital platform overview, client portal, dashboard, Mission Control, Block Ops Wiki / Compendium, Supabase data model, and design handoff process with Max for technical accuracy.",
    "primaryOwner": "Max",
    "status": "ready",
    "priority": "critical",
    "workstream": "Block Ops Wiki Buildout",
