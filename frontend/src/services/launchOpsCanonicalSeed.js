...
export const CANONICAL_LAUNCH_TASKS = [
...

  {
    ...
    "description": "Define the controlled Wikipedia-style link map for core Block Ops concepts so cross-linking is useful, governed, and not link-spam. Include page hubs, allowed internal links, and client-facing visibility cautions.",
    "primaryOwner": "Bloq",
    "status": "ready",
    "priority": "high",
  ...
  },
  {
    ...
    "description": "Add governed Related Pages sections to active/internal Block Ops Wiki pages, starting with Mission Control, Outreach Sequence, Lead Capture, CRM Pipeline Stages, Client Portal Rules, Status Rules, and Wiki governance pages.",
    "primaryOwner": "Bloq",
    "status": "ready",
    "priority": "high",
    "workstream": "Wiki Cross-Linking",
  ...
  },
  {
    ...
    "description": "Add natural inline links between major concepts without over-linking repeated terms. Keep client-facing visibility rules in mind so internal-only pages are not accidentally surfaced through client-safe paths.",
    "primaryOwner": "Bloq",
    "status": "locked",
    "priority": "medium",
    "workstream": "Wiki Cross-Linking",
  ...
  },
  {
    ...
    "description": "Create or update hub/index pages such as Sales / Outreach Index, Mission Control Index, Client Portal Index, Wiki Governance Index, Implementation Bundle Index, and M1 Index so users can navigate by topic.",
    "primaryOwner": "Bloq",
    "status": "locked",
    "priority": "medium",
    "workstream": "Wiki Cross-Linking",
  ...
  },
  {
    ...
    "description": "Check for broken links, orphan pages, pages with no outbound links, duplicate concepts, and links that could leak internal-only or draft content into client-facing paths.",
    "primaryOwner": "Max",
    "status": "locked",
    "priority": "high",
    "workstream": "Wiki Cross-Linking",
