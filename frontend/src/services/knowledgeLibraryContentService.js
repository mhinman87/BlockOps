...
export const fetchKnowledgeLibraryItems = async ({ scope = 'global', siteId = null, client } = {}) => {
  if (scope === 'rendered') {
    ...
    return buildKnowledgeLibraryItems(renderedRows);
  }
  ...
  return buildKnowledgeLibraryItems(filterRepresentationsByScope(normalized, { scope, siteId }));
};
