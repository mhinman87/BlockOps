  ...
  return (
    <DashboardLayout>
        ...
        {placeholderMetrics.map((metric, index) => {
          ...
          return (
            <div key={index} className="bg-white border border-gray-200 rounded-xl p-5">
              ...
              <p className="text-xs text-gray-400 font-light mt-1">{metric.description}</p>
            </div>
          );
        })}
      </div>
      ...
      <div className="bg-white border border-dashed border-gray-300 rounded-xl p-12 text-center">
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-2">Analytics Unlock During Phase 2</h2>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <span className="text-xs font-semibold px-3 py-1 rounded-full bg-gray-100 text-gray-500">Block Success Tracking</span>
          <span className="text-xs font-semibold px-3 py-1 rounded-full bg-gray-100 text-gray-500">PACU Time Analysis</span>
          <span className="text-xs font-semibold px-3 py-1 rounded-full bg-gray-100 text-gray-500">Opioid Reduction Metrics</span>
          <span className="text-xs font-semibold px-3 py-1 rounded-full bg-gray-100 text-gray-500">Competency Tracking</span>
          <span className="text-xs font-semibold px-3 py-1 rounded-full bg-gray-100 text-gray-500">Revenue Impact</span>
          <span className="text-xs font-semibold px-3 py-1 rounded-full bg-gray-100 text-gray-500">Quarterly Reports</span>
        </div>
      </div>
    </DashboardLayout>
  );
